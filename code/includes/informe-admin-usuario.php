...
if (isset($_POST['generarInforme'])) {
    ...
    if (strlen($_POST['fechaInicial']) >= 1 && strlen($_POST['fechaFinal']) >= 1 && $_POST['opUsuario'] >= 1) {
        ...
        $consultaP1 = "SELECT id FROM servicio WHERE usuario_cedula='$usuario' AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $consultaP17 = "SELECT id FROM servicio WHERE cargador_id=1 AND usuario_cedula='$usuario' AND tipo_servicio_id = 4  AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $consultaP18 = "SELECT id FROM servicio WHERE cargador_id=2 AND usuario_cedula='$usuario' AND tipo_servicio_id = 4  AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
