...
if (isset($_POST['generarInforme'])) {
    ...
    if (strlen($_POST['fechaInicial']) >= 1 && strlen($_POST['fechaFinal']) >= 1) {
        ...
        $consultaP1 = "SELECT id FROM servicio WHERE usuario_cedula='$cedulaG' AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $consultaC1 = "SELECT SUM(cantidad_dobletroque), SUM(cantidad_tractomulas) FROM servicio WHERE usuario_cedula='$cedulaG' AND cargador_id=1 AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $consultaC2 = "SELECT SUM(cantidad_dobletroque), SUM(cantidad_tractomulas) FROM servicio WHERE usuario_cedula='$cedulaG' AND cargador_id=2 AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $consultaP17 = "SELECT id FROM servicio WHERE cargador_id=1 AND usuario_cedula='$cedulaG' AND tipo_servicio_id = 4  AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $consultaP18 = "SELECT id FROM servicio WHERE cargador_id=2 AND usuario_cedula='$cedulaG' AND tipo_servicio_id = 4  AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $consultaP16 = "SELECT id FROM servicio WHERE cargador_id=1 AND ususario_cedula='$cedulaG' AND tipo_servicio_id = 3  AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        $_SESSION['tArrume'] = $tiempoArrume;
                ...
                $consultaP19 = "SELECT id FROM servicio WHERE cargador_id=2 AND ususario_cedula='$cedulaG' AND tipo_servicio_id = 3  AND fecha_inicial >= '$f1' AND fecha_final < DATE_ADD('$f2', INTERVAL 1 DAY)";
        ...
        if ($resultadoC1) {
            ...
            alert("Algo Salio mal por favor intentelo de nuevo'.$cedulaG.'");
