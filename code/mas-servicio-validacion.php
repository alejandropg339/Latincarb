...
include_once('includes/finalizarServicioMasValidado.php');
...
<body>
    <div class="container">
        ...
        <div class="article">
            <p class="article-service-ms" style="text-align: center;">Servicio iniciado a las: <br>
                <?php echo " ".$resultadoFinalBusqueda2 ?></p>
